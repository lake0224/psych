...
class RankingModel(CsvModel):
    ...
    def __init__(self, csv_file = None, *args, **kwargs):
        ...
        self.column = [RANKING_COLUMN_NAME,RANKING_COLUMUN_COUNT]
    ...
    def load_data(self):
        ...
        with open(self.csv_file, 'r+') as csv_file:
            ...
            for row in reader:
                self.data[row[RANKING_COLUMN_NAME]] = int(row[RANKING_COLUMUN_COUNT])
        return self.data
    ...
    def get_most_popular(self, not_list= None):
        ...
        Args:
            not_llist(list): Excludes the name on the list.
        Returns:
